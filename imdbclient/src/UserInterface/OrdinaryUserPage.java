...
public class OrdinaryUserPage extends JFrame {
	...
	public OrdinaryUserPage(ObjectInputStream objectIn, PrintWriter output,String UserName) {
		...
		comboBox.setBounds(272, 280, 86, 20);
...
////////////////////////////////////////////////////////////////////////////////////////////
		...
		btnRate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(SelectedIndex>=0){
				RateFrame rate=new RateFrame(objectIn, output,Filmlist.get(SelectedIndex).getname(),OrdinaryUserPage.this.UserName);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(SelectedIndex!=-1){	
					if(Filmlist.isEmpty()){
						...
						listModel.removeAllElements();
						DefaultListModel dlm=new DefaultListModel();
						dlm.addElement("Please Search First");
						list_1.setModel(dlm);
					}else{
						message="ShowReviews#FilmName:"+Filmlist.get(SelectedIndex).getname()+"*#";
						output.println(message);
						try {
							response = (Response) objectIn.readObject();
							String result = response.GetResult();
							if(result.equals("Ready")){
								...
								ReviewsList RL=new ReviewsList(Ratelist,Filmlist.get(SelectedIndex).getname());
								RL.setVisible(true);
							}
							else{
								JOptionPane.showMessageDialog(null, "No Review Was Submit");
							}
		...
		btnNewButton_1.setBounds(618, 279, 95, 23);
