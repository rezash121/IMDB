...
public class Sign_up extends JFrame {
	...
	public Sign_up(ObjectInputStream objectIn,PrintWriter output) {
		...
		btnSignUp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if((usernametxtfld.getText().equals("")||passwordField.getText().equals("")
					...
					output.println("signup#username:"+usernametxtfld.getText()+
				...
				if(result.equals("completed"))
					{setVisible(false);
					JOptionPane.showMessageDialog(null, "Sign up is completed");
					}else 
