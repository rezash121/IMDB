...
public class Rate implements java.io.Serializable {
	...
	public String toString(){
		return "FilmName: "+Filmname+" username: "+username+" rateNumber: "+rateNumber+" Title: "+
	" Discription: "+Discription+" firstR: "+getFirstRefreeResult()+" secondR: "+getSecondRefreeResult()+
	" third: "+getThirdRefreeResult();
	}
